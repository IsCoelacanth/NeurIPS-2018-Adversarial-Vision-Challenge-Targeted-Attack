...
from foolbox2.distances import MeanSquaredMedianDistance
...
from smiterative2 import SAIterativeAttack, RMSIterativeAttack, AdamIterativeAttack, AdagradIterativeAttack, NAGIterativeAttack
import os, csv
...
def run_attack(model, image, target_class, pos_salience):
    ...
    distance = MeanSquaredMedianDistance
